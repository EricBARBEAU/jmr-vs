...
function AboutContent() {
  return (
    <div className="about_content">
		...
		<div className="content_blk about_info ctnr_cntr">
			<div className="about_info-id">
				<div className="id_content">
					<div className="id_picture">
					</div>
					<div className="id_data">
						<div className="data_row data_row-1">
							...
							<div className="data_column">
								<span>Business</span>
								<div>JMR Visa Services</div>
							</div>
						</div>
						<div className="data_row data_row-2">
							<div className="data_column">
